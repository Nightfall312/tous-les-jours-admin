...
const Navbar = () => {
    ...
    const linkClass = ({ isActive }) =>
        `font-semibold transition ${isActive ? "text-[#0b5a35]" : "text-slate-600 hover:text-[#0b5a35]"
        }`;

    return (
        <header className="sticky top-0 z-40 border-b border-[#e6dccb] bg-[white]/95 backdrop-blur">
